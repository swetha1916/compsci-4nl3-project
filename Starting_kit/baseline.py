...
print("Majority baseline (weighted F1):", f1_score(y_val, majority_pred, average="weighted"))
...
print("Logistic Regression (weighted F1):", f1_score(y_val, lr_pred, average="weighted"))

# Random Forest
rf = RandomForestClassifier(n_estimators=100, random_state=42)
rf.fit(X_train_vec.toarray(), y_train)
rf_pred = rf.predict(X_val_vec.toarray())
print("Random Forest (weighted F1):", f1_score(y_val, rf_pred, average="weighted"))
...
print("Feedforward Neural Network (weighted F1):", f1_score(y_val, nn_pred, average="weighted"))
